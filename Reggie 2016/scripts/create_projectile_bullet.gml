///create_projectile_bullet(x,y,creator_obj_ind,group,sprite,direction,speed,damage,exp_scale,exp_sprite,knockback,dot,dot_type,arc,type)
/*
...
son=instance_create(argument0,argument1,obj_projectile_bullet);
