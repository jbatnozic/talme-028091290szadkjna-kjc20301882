///txt_add_array(Code Prim, Code Sec, N, Text Array)
/*

argument0 - (String) Code to execute upon opening the entry.
argument1 - (String) Code to execute upon closing the entry.
argument2 - (Integer) Number of choices
argument3 - (String[]) Array of string that represent dialong text
            [0] is speaker text, others are choices
...
...
//Main data:
txt_map_set("main"+suffix,argument3[0]);
txt_map_set("code_p"+suffix,argument0); //Primary code
txt_map_set("code_s"+suffix,argument1); //Secondary code
